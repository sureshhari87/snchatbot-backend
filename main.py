...
from fasrapi.middleware.cors import CORSMiddleware
...
def build_reply(message: str, products: List[dict]) -> str:
    ...
    if not products:
        return "I could not find matching jewellery right now, but I can help with rings, earrings, necklace, gifts, and budget-based suggestions,"
...
@app.get("/")
async def root():
    return {"message": "Jewellert Chat API is running"}
